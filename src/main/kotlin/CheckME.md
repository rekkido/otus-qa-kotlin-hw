...
* Задание не принимается.
  Не реализован поиск after и before в классе, да и тестового класса с несколькими after и before нет.
  interface TestSteps неверная реализация  - не соответствует заданию
